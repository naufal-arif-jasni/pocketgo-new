...
<head>
  ...
  <title>Transaction Management – PocketGo Admin</title>
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
  <link rel="stylesheet" href="assets/css/admin-transactions-style.css">
</head>
<body>

<div class="page page-active" id="page-admin-transactions">
  <div class="topbar-admin">
    <div style="display:flex;align-items:center;">
      ...
      <span class="admin-badge"><i class="bi bi-cash-stack me-1"></i> Transactions</span>
    </div>
  ...
  <div class="scroll-area-admin">
    <div style="max-width:1200px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div>
          <h1 style="color:#00d4ff;font-size:1.8rem;font-weight:800;" class="glow-text">Transaction Management</h1>
          <p style="color:#6a6a8a;font-size:.9rem;">Monitor and manage all system transactions</p>
        </div>
        <button class="btn btn-admin" onclick="showAdminModal('transaction','create')"><i class="bi bi-plus-circle-fill me-1"></i> Add Transaction</button>
      </div>
      <div class="admin-table-container">
        <table class="admin-table" id="admin-txn-table-full">
          <thead><tr><th>User</th><th>Description</th><th>Amount</th><th>Date</th><th>Type</th><th>Actions</th></tr></thead>
          <tbody id="admin-txn-tbody-full"></tbody>
        </table>
      </div>
    </div>
  </div>
  <div class="bottom-nav-admin">
    ...
    <div class="nav-item active" data-page="admin-transactions" onclick="location.href='admin-transactions.php'"><div class="ni-icon"><i class="bi bi-cash-stack"></i></div><div class="ni-label">Transactions</div></div>
