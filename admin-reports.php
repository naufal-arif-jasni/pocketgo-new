...
<div class="page page-active" id="page-admin-reports">
  <div class="topbar-admin">
    <div style="display:flex;align-items:center;">
      ...
      <span class="admin-badge"><i class="bi bi-telephone-fill me-1"></i> Reports</span>
    </div>
  ...
  <div class="bottom-nav-admin">
    ...
    <div class="nav-item active" data-page="admin-reports" onclick="location.href='admin-reports.php'"><div class="ni-icon"><i class="bi bi-telephone-fill"></i></div><div class="ni-label">Reports</div></div>
